                    ...
                    <div class="sidebar-item sidebar-filters" id="sidebarFilters">
                        ...
                        <div class="accordion-group" id="tourStep3">
                            ...
                            <div id="filterTwo" class="accordion-body collapse">
                                <div class="accordion-inner">
                                    <a href="#" data-target="xs" data-type="size" class="selectable detailed"><i class="box"></i> تست</a>
                                    <a href="#" data-target="s" data-type="size" class="selectable detailed"><i class="box"></i> تست</a>
                    	        ...
                    	        <div class="product">
                                    <a style="text-decoration:none" href="<?php echo base_url('Indexcontroller/single_product/'.$product->ID) ?>">
                                        ...
                                        <div class="main-titles no-margin">
                                            <h4 class="title"><?php echo $product->Price.' تومان '; ?></h4>
                                            <h5 class="no-margin isotope--title"><?php echo $product->Title ?></h5>
                                        </div>
                                    </a>
                    	        </div>
                    	    </div> <!-- /single product -->
